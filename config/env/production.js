...
module.exports = {
  ...
  sockets: {
    ...
    ***************************************************************************/
    onlyAllowOrigins: [
      ...
      'http://localhost:3000',
      'http://ameinfo.cf',
      'http://admin.ameinfo.cf',
      'https://ameinfo.com',
      'https://admin.ameinfo.com'
    ],
  ...
  **************************************************************************/
  ssl: {
    cert: require('fs').readFileSync(require('path').resolve(__dirname,'../ssl/publickey.pem')),
    key: require('fs').readFileSync(require('path').resolve(__dirname,'../ssl/privatekey.pem'))
  },
  ...
  ***************************************************************************/
  custom: {
    siteUrl: 'https://ameinfo.com',
    adminUrl: 'https://admin.ameinfo.com/#',
    s3AccessKey: 'AKIAJ5IAPCALOLDBFHYQ',
    s3SecretKey: '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',
    s3Bucket: 'ameinfo-images',
    s3Region: 'ap-southeast-1',
    openWeatherLanguage: 'en',
    openWeatherCityId: 292223,
    openWeatherAppId: 'cd2a07fd393763250420fb20a292741d',
    emarsysUsername: 'mediaquest003',
    emarsysSecret: 'ocRydgw14ikW1iKvTeW9',
